...
const Home = ({ screenWidth }) => {
    ...
    return (
        ...
        <main>
            ...
            <Box component='section' sx={{ ml: { xs: -1.25, sm: 0 } }} className="home-container">
            ...
            <Box component='section' py={{ xs: 5, sm: 16 }} sx={{ width: { xs: '320px', sm: '70%' }, height: 'auto', alignItems: 'center', justifyContent: 'center', margin: '0 auto', textAlign: 'center', mt: { xs: -30, sm: -40, md: 0 } }}>
                <div >
