    ...
    return (
        <div className="shipping-policy">
            ...
            <div className="container">
                ...
                <h3>Herbal Zestfulness Privacy Policy  </h3>
                ...
                <ul>
                    ...
                    <li>"Company" (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Neurogan.</li>
                    ...
                    <li>"Website" refers to Neurogan Website accessible from www.neurogan.com.</li>
                ...
                <p> For any concerns or queries regarding handling and protecting your personal data, you can request contact with our Data Controller Representative at support@neurogan.com.</p>

                <p> If you have any general questions about this Privacy Policy, You can contact us:</p>

                <ul>
                    <li>By visiting this page on our website: <a href="https://neurogan.com/pages/contact">https://neurogan.com/pages/contact</a></li>
                    <li>By sending us an email: <a href="mailto:support@neurogan.com">support@neurogan.com</a></li>
                </ul>
